...
describe("customers", () => {
  ...
  describe("all", () => {
    ...
    it("returns all added customers", () => {
      ...
      expect(result[oneId].firstName).toEqual(
        one.firstName
      );
      expect(result[twoId].firstName).toEqual(
        two.firstName
      );
    });
  });
  ...
  describe("isValid", () => {
    ...
    it("returns true for a valid object", () => {
      expect(
        new Customers().isValid(customer)
      ).toBeTruthy();
    });
    ...
    it("returns false for an invalid object", () => {
      ...
      expect(
        new Customers().isValid(newCustomer)
      ).toBeFalsy();
    });
  });
  ...
  describe("generateFakeCustomers", () => {
    ...
    it("generates some data", () => {
      ...
      expect(customers[0].lastName).toMatch(
        /^[\w']+$/
      );
      expect(customers[0].phoneNumber).toMatch(
        /^[0-9()\- ]+$/
      );
    });
  });

...
describe("MenuButtons", () => {
  ...
  describe("reset button", () => {
    ...
    it("is disabled initially", () => {
      renderWithStore(<MenuButtons />);
      expect(
        buttonWithLabel("Reset").hasAttribute("disabled")
      ).toBeTruthy();
    });
  ...
  describe("skip animation button", () => {
    it("renders", () => {
      renderWithStore(<MenuButtons />);
      expect(buttonWithLabel("Skip animation")).not.toBeNull();
    });
    ...
    it("is disabled if animations have already been skipped", () => {
      ...
      expect(
        buttonWithLabel("Skip animation").hasAttribute(
          "disabled"
        )
      ).toBeTruthy();
    });
  ...
  describe("sharing button", () => {
    ...
    it("renders Stop sharing if sharing has started", () => {
      ...
      expect(buttonWithLabel("Stop sharing")).not.toBeNull();
    });
